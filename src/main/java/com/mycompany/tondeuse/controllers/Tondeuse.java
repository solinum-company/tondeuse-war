...
import static com.mycompany.tondeuse.model.Command.*;
import static com.mycompany.tondeuse.model.Direction.*;
...
import com.mycompany.tondeuse.model.Command;
import com.mycompany.tondeuse.model.Direction;
...
public class Tondeuse {
	...
	public Tondeuse(int x, int y, Direction direction, List<Command> commands, int lawnWidth, int lawnHeight) {
		this.x = x;
		this.y = y;
	...
	public static Tondeuse readConfig(String position, String commandChars, int lawnWidth, int lawnHeight) {
		...
		return new Tondeuse(parseInt(config[0]), parseInt(config[1]), DIRECTIONS_BY_NAME.get(config[2]), commands, lawnWidth, lawnHeight);
	}
